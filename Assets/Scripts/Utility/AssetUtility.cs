...
public static class AssetUtility
{
    ...
    {
        return string.Format("Assets/GameMain/Localization/{0}/Dictionaries/{1}.xml");
    }

    public static string GetFontAsset(string assetName)
    {
        return string.Format("Assets/GameMain/Localization/{0}/Fonts/{1}.ttf");
    }
    ...
    {
        return string.Format("UI/UIForms/{0}", assetName);
    }
