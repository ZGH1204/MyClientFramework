...
namespace ZFramework.UI
{
    ...
    public sealed class OpenUIFormDependencyAssetEventArgs : EventArgs
    {
        ...
        public OpenUIFormDependencyAssetEventArgs(int serialId, string uiFormAssetName, string uiGroupName, string dependencyAssetName, int loadedCount, int totalCount, object userData)
        {
            SerialId = serialId;
