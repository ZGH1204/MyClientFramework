...
namespace SuperScrollView
{
    ...
    /// <summary>
    /// ScrollRect控制类，实现自动轮换Item，节省内存；增删查改Item；控制Item的尺寸；自动对齐Item等
    /// </summary>
    public class LoopListView2 : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler
    {
        ...
        /// <summary>
        /// 创建新的Item的回调并返回新的Item,便于初配置Item信息；第二个参数是唯一id
        /// </summary>
        private System.Func<LoopListView2, int, LoopListViewItem2> mOnGetItemByIndex;
        ...
        /// <summary>
        /// Item位置管理器,用到分组的逻辑，只考虑运动方向的单位长度；
        /// </summary>
        ...
        /// <summary>
        /// 是否支持ScrollBar功能，如果支持，必须存在ScrollBar组件;
        /// </summary>
        [SerializeField]
        ...
        /// <summary>
        /// Item是否自动调整对齐到边界点，需要调整好Item的轴点，ViewPort的轴点；
        /// </summary>
        [SerializeField]
        private bool mItemSnapEnable = false;
