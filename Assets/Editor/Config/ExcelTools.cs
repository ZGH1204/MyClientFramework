...
public class ExcelTools : EditorWindow
{
    ...
    /// 输出格式
    /// </summary>
    private static string[] formatOption = new string[] { "JSON", "CSV", "XML", "LUA", "C#" };
    ...
    private void DrawOptions()
    {
        ...
        EditorGUILayout.LabelField("生成格式类型:", GUILayout.Width(85));
        indexOfFormat = EditorGUILayout.Popup(indexOfFormat, formatOption, GUILayout.Width(125));
        GUILayout.EndHorizontal();

        GUILayout.BeginHorizontal();
        EditorGUILayout.LabelField("生成编码类型:", GUILayout.Width(85));
    ...
    private static void Convert()
    {
        ...
        {
            //获取Excel文件的绝对路径
            string excelPath = Application.dataPath.Replace("Assets", "") + assetsPath;
            //构造Excel工具类
            ...
            {
                output = excelPath.Replace(".xlsx", "CSV.cs");
                excel.ConvertToCSharp(output, encoding);
            }
