...
namespace ZFramework.Runtime
{
    ...
    public static class GameEntry
    {
        ...
        private static readonly LinkedList<ZFrameworkComponent> s_GameFrameworkComponents = new LinkedList<ZFrameworkComponent>();
        ...
        public static T GetComponent<T>() where T : ZFrameworkComponent
        {
        ...
        /// <returns>要获取的游戏框架组件。</returns>
        public static ZFrameworkComponent GetComponent(Type type)
        {
            LinkedListNode<ZFrameworkComponent> current = s_GameFrameworkComponents.First;
            while (current != null)
            {
        ...
        /// <returns>要获取的游戏框架组件。</returns>
        public static ZFrameworkComponent GetComponent(string typeName)
        {
            LinkedListNode<ZFrameworkComponent> current = s_GameFrameworkComponents.First;
            while (current != null)
            {
        ...
        internal static void RegisterComponent(ZFrameworkComponent gameFrameworkComponent)
        {
