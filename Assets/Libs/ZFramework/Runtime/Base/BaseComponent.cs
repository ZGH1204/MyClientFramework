...
namespace ZFramework.Runtime
{
    ...
    public sealed class BaseComponent : ZFrameworkComponent
    {
        ...
        [SerializeField]
        private string m_LogHelperTypeName = "ZFramework.Runtime.LogHelper";

        [SerializeField]
        private string m_ZipHelperTypeName = "ZFramework.Runtime.ZipHelper";

        [SerializeField]
        private string m_JsonHelperTypeName = "ZFramework.Runtime.JsonHelper";
        ...
        protected override void Awake()
        {
            ...
            InitLogHelper();
            Log.Info("Game Framework version is {0}", ZFrameworkEntry.Version);
        ...
        private void Update()
        {
            ZFrameworkEntry.Update(Time.deltaTime, Time.unscaledDeltaTime);
        }
        ...
        private void InitLogHelper()
        {
            ...
            {
                throw new Exception(string.Format("Can not find log helper type '{0}'.", m_LogHelperTypeName));
            }

            Log.ILogHelper logHelper = (Log.ILogHelper)Activator.CreateInstance(logHelperType);
            if (logHelper == null)
            {
                throw new Exception(string.Format("Can not create log helper instance '{0}'.", m_LogHelperTypeName));
            }
