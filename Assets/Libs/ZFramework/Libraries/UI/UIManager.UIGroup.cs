    ...
    internal partial class UIManager
    {
        ...
        private sealed partial class UIGroup : IUIGroup
        {
            ...
            public void RemoveUIForm(IUIForm uiForm)
            {
                ...
                if (uiFormInfo == null)
                {
                    Log.Error(string.Format("Can not find UI form info for serial id '{0}', UI form asset name is '{1}'.", uiForm.SerialId.ToString(), uiForm.UIFormAssetName));
                }
            ...
            public void RefocusUIForm(IUIForm uiForm, object userData)
            {
                ...
                if (uiFormInfo == null)
                {
                    Log.Error("Can not find UI form info.");
                }
