...
namespace ZFramework.Runtime
{
    ...
    public sealed class SettingComponent : ZFrameworkComponent
    {
        private ISettingManager m_SettingManager = null;

        [SerializeField]
        private string m_SettingHelperTypeName = "ZFramework.Runtime.DefaultSettingHelper";
