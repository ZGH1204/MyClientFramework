...
namespace ZFramework.Network
{
    ...
    public interface INetworkChannel
    {
        ...
        //ZFrameworkAction<INetworkChannel, object> NetworkChannelConnected { get; set; }
        //ZFrameworkAction<INetworkChannel> NetworkChannelClosed { get; set; }
        //ZFrameworkAction<INetworkChannel, int, object> NetworkChannelSended { get; set; }
        //ZFrameworkAction<INetworkChannel, int> NetworkChannelMissHeartBeat { get; set; }
        //ZFrameworkAction<INetworkChannel, NetworkErrorCode, string> NetworkChannelError { get; set; }
        //ZFrameworkAction<INetworkChannel, object> NetworkChannelCustomError { get; set; }
    }
}