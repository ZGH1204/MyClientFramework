    ...
    internal sealed class Fsm<T> : FsmBase, IFsm<T> where T : class
    {
            ...
            : base(name)
        {
            ...
            foreach (FsmState<T> state in states)
            {
                ...
                {
                    throw new Exception(string.Format("FSM '{0}' state '{1}' is already exist.", Utility.Text.GetFullName<T>(name), stateName));
                }
        ...
        public void Start<TState>() where TState : FsmState<T>
        {
            ...
            if (state == null)
            {
                throw new Exception(string.Format("FSM '{0}' can not start state '{1}' which is not exist.", Utility.Text.GetFullName<T>(Name), typeof(TState).FullName));
            }
        ...
        public void Start(Type stateType)
        {
            ...
            if (state == null)
            {
                throw new Exception(string.Format("FSM '{0}' can not start state '{1}' which is not exist.", Utility.Text.GetFullName<T>(Name), stateType.FullName));
            }
        ...
        public void FireEvent(object sender, int eventId)
        {
            ...
            m_CurrentState.OnEvent(sender, eventId, null);
        }
        ...
        public void FireEvent(object sender, int eventId, object userData)
        {
            ...
            m_CurrentState.OnEvent(sender, eventId, userData);
        }
        ...
        public void ChangeState(Type stateType)
        {
            ...
            if (state == null)
            {
                throw new Exception(string.Format("FSM '{0}' can not change state to '{1}' which is not exist.", Utility.Text.GetFullName<T>(Name), stateType.FullName));
            }
